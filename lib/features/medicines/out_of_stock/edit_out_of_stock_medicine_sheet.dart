...
class EditOutOfStockMedicineSheet extends StatefulWidget {
  final Medicine? medicine;
  final String? userId;
  final bool isAnonymous;

  const EditOutOfStockMedicineSheet({
    super.key,
    this.medicine,
    this.userId,
  ...
  State<EditOutOfStockMedicineSheet> createState() => _EditOutOfStockMedicineSheetState();
}

class _EditOutOfStockMedicineSheetState extends State<EditOutOfStockMedicineSheet> {
